<?php
namespace Ukn\Person\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Ukn\Person\Controller\PersonController.
 *
...
class PersonControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Ukn\Person\Controller\PersonController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Ukn\\Person\\Controller\\PersonController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPersonsFromRepositoryAndAssignsThemToView()
	{
		...
		$personRepository = $this->getMock('Ukn\\Person\\Domain\\Repository\\PersonRepository', array('findAll'), array(), '', FALSE);
