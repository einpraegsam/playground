<?php
namespace In2code\Person\Tests\Unit\Controller;
...
{
    /**
     * @var \In2code\Person\Controller\PersonController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\In2code\Person\Controller\PersonController::class)
    ...
    public function listActionFetchesAllPersonsFromRepositoryAndAssignsThemToView()
    {
        ...
        $personRepository = $this->getMockBuilder(\In2code\Person\Domain\Repository\PersonRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
