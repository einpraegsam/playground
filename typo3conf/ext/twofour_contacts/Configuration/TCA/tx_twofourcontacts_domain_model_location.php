...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:twofour_contacts/Resources/Private/Language/locallang_db.xlf:tx_twofourcontacts_domain_model_location',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'interface' => [
        'showRecordFieldList' => 'title, address, city, zip',
    ],
    'types' => [
        '1' => ['showitem' => 'title, address, city, zip'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
