...
class LightboxViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    public function render()
    {
        ...
        foreach ($fotos as &$foto) {
            ...
            if ($internet != 0) {
                ...
                if ($dateinname != "link") {
                    $carosel_item_array[$i] .=
                        "<div class=\"col\">\n" .
                        "<img src=\"http://digilib.bbaw.de/digitallibrary/servlet/Scaler?fn=/silo10/CIL/" . $dateinname . "&dh=400\" style=\"height: 400px;\" />\n
                            </div>\n";
                }
                $carosel_item_array[$i] .=
                    "<div class=\"col\">\n
        ...
        foreach ($fotos as $foto) {
            ...
            <div id=\"searchResultCarousel\" class=\"carousel slide\" data-interval=\"false\">\n";
                ...
                for ($i = 1; $i < count($carosel_item_array); $i++) {
